...
Improvement view v001 · built on flow library v008 (app 1b22445) · updated 2026-08-27
...
14 screens · reviewed 2026-08-23 · 14 recommendations

**Screens:** 01 Intro — scan a driver's licence · 02 Capture — front of licence · 03 Capture — back of licence · 04 Processing your scan · 05 That didn't read · 06 Enter license manually · 07 Search results · 08 We found a matching customer (prop 1) · 09 Review customer — read-first document · 10 Edit sheet (bottom sheet) · 11 Create new customer (prop 3) · 12 Information conflict · 13 Verify the number (bottom sheet) · 14 Customer added / updated
...
- **Screen:** 02 Capture — front of licence (`current/03-license-scan/02-scan-front.png`) — also on Scan Driver's License · 03 Capture — back of licence; Scan Driver's License · 05 That didn't read
...
- **Screen:** 02 Capture — front of licence (`current/03-license-scan/02-scan-front.png`) — also on Scan Driver's License · 08 We found a matching customer (prop 1); Scan Driver's License · 12 Information conflict
...
- **Screen:** 11 Create new customer (prop 3) (`current/03-license-scan/11-scan-verify-new.png`) — also on Scan Driver's License · 09 Review customer — read-first document
- **Type:** Pattern Opportunity · **Category:** structural · **Severity:** Major · **Priority:** High · **Fix size:** medium
...
- **Screen:** 09 Review customer — read-first document (`current/03-license-scan/09-scan-verify-existing.png`) — also on Scan Driver's License · 11 Create new customer (prop 3)
...
- **Screen:** 08 We found a matching customer (prop 1) (`current/03-license-scan/08-scan-match-found.png`)
...
- **Screen:** 12 Information conflict (`current/03-license-scan/12-scan-conflict.png`)
- **Type:** Newly Detected UI Issue · **Category:** informational · **Severity:** Major · **Priority:** High · **Fix size:** small
...
- **Screen:** 05 That didn't read (`current/03-license-scan/05-scan-not-recognized.png`)
- **Type:** Newly Detected UI Issue · **Category:** informational · **Severity:** Minor · **Priority:** Medium · **Fix size:** small
...
**D. Ride Price adaptation.** RESOLVED (PR #49): the refusal now says one thing — 'We couldn't find the barcode. Keep the whole barcode visible and avoid glare.' — and the demo boundary lives in its own one-line hint. Restructure the copy only: the headline stays; then two short lines — 'In this demo, only the 5 printed training licenses can be read.' and 'Blurry or shadowed photo? Retake usually fixes it.' — then the two actions as today (Retake primary per decision 13, Enter manually secondary). No diagnosis is claimed the app cannot make. **Stays:** Retake-then-manual order (decision 13); the neutral teaching voice; no cause classification (invariant 4).
...
- **Screen:** 04 Processing your scan (`current/03-license-scan/04-scan-reading.png`)
- **Type:** Newly Detected UI Issue · **Category:** informational · **Severity:** Observation · **Priority:** Low · **Fix size:** small
...
**D. Ride Price adaptation.** OBSOLETE (re-scored 2026-08-27): the journey is full-screen — there is no dialog left to jump in height. Render the spinner inside the capture frame's own footprint (the 248×155 box, dashed becomes solid), Upload disabled, so the dialog height holds through capture → reading → result. The stepper stays on '2 · Back'. **Stays:** The spinner, the copy (plus RP-IMP-015's line), the stepper logic.
...
- **Screen:** 03 Capture — back of licence (`current/03-license-scan/03-scan-back.png`)
...
**D. Ride Price adaptation.** RESOLVED (PR #49): the back-capture panel draws the barcode side (the BACK OF LICENSE card with its bar band) and the tip names the side's real requirement — 'Keep the whole barcode visible and steady.' Inside step 2's frame, draw a faint wide-strip silhouette (CSS bars, no asset) where the marker sits on the props, and add one hint line: 'Lay it flat — avoid glare on the stripe.' No live viewfinder (invariant 5); this is the pre-capture illustration. **Stays:** The frame-as-control, the file-input capture path, the front-thumbnail-with-retake.
...
- **Screen:** 02 Capture — front of licence (`current/03-license-scan/02-scan-front.png`) — also on Scan Driver's License · 03 Capture — back of licence
- **Type:** Newly Detected UI Issue · **Category:** visual · **Severity:** Minor · **Priority:** Low · **Fix size:** small
...
- **Screen:** 09 Review customer — read-first document (`current/03-license-scan/09-scan-verify-existing.png`) — also on Scan Driver's License · 03 Capture — back of licence
...
**D. Ride Price adaptation.** SUPERSEDED (PR #49): the step chips became five slim dots in the one-row chrome — the orientation survived at almost no vertical price, which is what this entry asked to weigh. No change on its own. If Q2 chooses the full-screen shell, revisit with the lighter treatment ('Scan license · 1 of 3' + thin gradient progress). **Stays:** The chips, today.
...
- **Screen:** 01 Intro — scan a driver's licence (`current/03-license-scan/01-scan-intro.png`)
