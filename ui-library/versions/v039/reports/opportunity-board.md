...
Updated 2026-09-19 · 2 of 20 product areas reviewed · 21 recommendations so far, 4 open. This board is generated from the screen improvement matrix and grows as each area is reviewed — until every area is in, "top" means top of what has been reviewed.
...
|---|---|---|---|---|---|---|---|
| 1 | RP-IMP-003 | Home — Deals Queue & Navigation | The card does not say what comes next, and the search-field camera promises the wrong scan | Medium | Minor | small | Partly built — PR #44 built the Next line; the camera half is still open |
| 2 | RP-IMP-004 | Home — Deals Queue & Navigation | The drawer spends the brand gradient on a selected state | Low | Minor | small | Open |
| 3 | RP-IMP-006 | Home — Deals Queue & Navigation | No login by design — keep the 'who am I' cue consistent | Low | Observation | small | Open — its Home-switch part superseded by owner ruling B (2026-09-18) |
| 4 | RP-IMP-005 | Home — Deals Queue & Navigation | A filter with no matches contradicts the title and offers no way back | Low | Observation | small | Open |
...
|---|---|---|---|---|---|
| RP-IMP-001 | Home — Deals Queue & Navigation | The only forward action sits in the hardest thumb zone while 60% of the screen is empty | Deferred | the owner kept New visit top right for now, shown the bottom bar on 2026-09-19 | 2026-09-19 |
...
|---|---|---|---|
| Home — Deals Queue & Navigation | 4 | 0 | 3 |
...
1. Open now: 4 of 21 recommendations, all on Home — the camera half of RP-IMP-003, RP-IMP-004, RP-IMP-005 and RP-IMP-006. RP-IMP-001 (New visit at the bottom) is deferred: shown both as pictures on 2026-09-19, the owner kept New visit top right for now. Home moved to the owner's kit after its 2026-08-23 review, so check each against today's screen before building from it.
