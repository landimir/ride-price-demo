...
| 5 | Discovery Session | 3 | Customer Onboarding — the Customer Resolver · 03 Customer found — confirm + registration address — Start Visit → (creates the deal) |
...
| 19 | Document Review (advisor) | 1 | Deal Jacket & Compliance · 07 Completed — already in the jacket — Tap a received customer document, then View |
